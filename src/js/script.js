...
const translations = {
  ...
  id: {
    ...
    md_aluminium_cutting: "PEMOTONGAN & MILLING ALUMINIUM",
    md_milling: "MILLING",
    md_rough_grinding: "GERINDA KASAR",
    md_cnc_machining: "PEMESINAN CNC",
    md_surface_grinding: "GERINDA PERMUKAAN",
    ...
    mp_ferrous_desc: "Divisi Logam kami memiliki kemampuan luar biasa dalam mengirimkan berbagai produk logam besi dalam berbagai spesifikasi. Kami sangat berpengalaman dalam bekerja dengan baja karbon AISI C1050 yang sangat serbaguna, baja tahan karat berkualitas tinggi, baja perkakas serbaguna, dan baja ringan karbon rendah. Logam-logam ini dikenal karena kekuatan dan daya tahannya, sehingga banyak digunakan dalam konstruksi, manufaktur, dan infrastruktur karena kemampuannya menahan beban berat dan suhu tinggi.",
    mp_nonferrous_metals: "LOGAM NON-BESI",
    mp_nonferrous_desc: "Pengalaman puluhan tahun kami juga mencakup pengiriman produk logam non-besi sesuai permintaan, di mana kami bekerja dengan material seperti aluminium, kuningan, perunggu, tembaga, grafit, dan titanium. Produk non-besi kami dihargai karena ketahanan korosinya, kemampuan bentuknya, dan sifatnya yang ringan, menjadikannya penting dalam industri seperti kedirgantaraan, elektronik, dan manufaktur otomotif di mana faktor-faktor seperti konduktivitas dan berat sangat penting.",
    mp_material_form: "BENTUK MATERIAL",
    mp_plate: "Pelat",
    mp_flat: "Flat",
    mp_shaft_rod: "Poros / Batang",
    mp_hexagon: "Heksagonal",
    mp_channel: "Kanal",
    mp_checker: "Checker",
    mp_square: "Persegi",
    ...
    mp_i_beam: "I-Beam",
    mp_aluminium: "ALUMINIUM",
    mp_tool_steel: "BAJA PERKAKAS",
    mp_machinery_steel: "BAJA MESIN",
    mp_aircraft_fastening: "SISTEM PENGIKAT PESAWAT",
    mp_stainless_steel: "BAJA TAHAN KARAT",
    mp_carbon_steel: "BAJA KARBON",
    mp_titanium: "TITANIUM",
    mp_aircraft_tool: "PERKAKAS PESAWAT",
    ...
    aero_fastening: "Tool / Perangkat Pesawat",
    ...
    aero_core_title: "Kemampuan inti kami di sektor terkait Aerospace lainnya juga mencakup:",
    ...
    about_hero_desc: "PHH Group didirikan pada tahun 1975, yang mengkhususkan diri dalam perdagangan logam perangkat keras. Selama 48 tahun terakhir, kemampuan Grup dalam solusi logam ferro dan non-ferro telah tumbuh pesat, memungkinkannya untuk sekarang memberikan rangkaian produk baja berkualitas paling komprehensif kepada pelanggan. Selain kehadiran lokalnya yang bereputasi, Grup telah, melalui aliansi strategis dan kolaborasi dengan mitra yang luar biasa, berekspansi ke pasar global, membawa merek solusi logam berkualitas tinggi dan dirancang khusus kepada klien internasional.",
